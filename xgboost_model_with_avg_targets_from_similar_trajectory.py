...
for w in range(2, 21):
    ...
    for k in range(1, 51):
        print(k)
        train_k_similar_targets, test_k_similar_targets = select_avg_k_similar_targets_train_test(train_similar_trajectories, test_similar_trajectories, k)
    ...
    results_train.to_csv(f"results_optimized_xgboost/train_xgboost_results_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.csv")
    results_test.to_csv(f"results_optimized_xgboost/test_xgboost_results_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.csv")

"""    
    plt.plot(maes)
    plt.savefig(f"plots/maes_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.png")
    plt.show()

    plt.plot(mapes)
    plt.savefig(f"plots/mapes_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.png")
    plt.show()

    plt.plot(mape100s)
    plt.savefig(f"plots/mape100s_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.png")
    plt.show()

    plt.plot(mape350s)
    plt.savefig(f"plots/mape350s_added_avg_k_similar_targets_window_size_{window_size}_weighted_euclidean.png")
    plt.show()
"""
