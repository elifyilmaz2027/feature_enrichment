...
train_similar_trajectories = np.load(
        f"prepared_data_similar_trajectories/train_300_similar_data_for_all_query_with_window_size_14_and_metric_weighted_euclidean.npy")
test_similar_trajectories = np.load(
        f"prepared_data_similar_trajectories/test_300_similar_data_for_all_query_with_window_size_14_and_metric_weighted_euclidean.npy")

train_k_similar_targets, test_k_similar_targets = select_k_similar_targets_train_test(
            train_similar_trajectories, test_similar_trajectories, 34)
train_test_k_similar_targets = concat_train_test_k_similar_targets(train_k_similar_targets, test_k_similar_targets)
...
df_train_preds.to_csv("predictions/train_bg_xgboost_2_l_14_k_34.csv")
df_test_preds.to_csv("predictions/test_bg_xgboost_2_l_14_k_34.csv")
